...
class IncendieTable extends StatefulWidget {
  const IncendieTable({Key? key}) : super(key: key);

  @override
  _IncendieTableState createState() => _IncendieTableState();
}

class _IncendieTableState extends State<IncendieTable> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FutureBuilder<List<IncendiesModel>>(
              ...
              future: context.read<IncendiesViewModel>().getAllNonTraite(),
