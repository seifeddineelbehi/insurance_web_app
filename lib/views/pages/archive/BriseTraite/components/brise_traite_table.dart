...
class BrisesTraiteTable extends StatefulWidget {
  const BrisesTraiteTable({Key? key}) : super(key: key);

  @override
  _BrisesTraiteTableState createState() => _BrisesTraiteTableState();
}

class _BrisesTraiteTableState extends State<BrisesTraiteTable> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FutureBuilder<List<BriseGlaceModel>>(
              ...
              future: context.read<BriseViewModel>().getAllTraite(),
