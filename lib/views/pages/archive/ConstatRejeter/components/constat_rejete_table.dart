...
class ConstatRejeteTable extends StatefulWidget {
  const ConstatRejeteTable({Key? key}) : super(key: key);

  @override
  _ConstatRejeteTableState createState() => _ConstatRejeteTableState();
}

class _ConstatRejeteTableState extends State<ConstatRejeteTable> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FutureBuilder<List<ConstatModel>>(
              ...
              future: context.read<HomeViewModel>().getAllConstatRejete(),
...
DataRow listConstatRejeteDataRow(
