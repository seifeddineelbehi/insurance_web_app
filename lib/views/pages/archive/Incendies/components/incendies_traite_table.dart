...
class IncendiesTraiteTable extends StatefulWidget {
  const IncendiesTraiteTable({Key? key}) : super(key: key);

  @override
  _IncendiesTraiteTableState createState() => _IncendiesTraiteTableState();
}
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FutureBuilder<List<IncendiesModel>>(
              ...
              future: context.read<IncendiesViewModel>().getAllTraite(),
