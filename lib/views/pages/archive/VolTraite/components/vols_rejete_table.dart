...
class VolsRejeteTable extends StatefulWidget {
  const VolsRejeteTable({Key? key}) : super(key: key);

  @override
  _VolsRejeteTableState createState() => _VolsRejeteTableState();
}

class _VolsRejeteTableState extends State<VolsRejeteTable> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FutureBuilder<List<VolModel>>(
              ...
              future: context.read<VolViewModel>().getAllVolsRejete(),
